        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="mission-card p-4 h-100 bg-white rounded shadow-sm text-center">
                    <div class="icon-box bg-opacity-10 text-primary rounded-circle p-3 mb-3 d-inline-flex mx-auto" style="background-color: var(--main-bg);">
                        <img src="assets/icons/home_health_24.svg" alt="Star Icon" width="36" height="36">
                    </div>
            ...
            <div class="col-md-4">
                <div class="mission-card p-4 h-100 bg-white rounded shadow-sm text-center">
                    <div class="icon-box bg-opacity-10 text-primary rounded-circle p-3 mb-3 d-inline-flex mx-auto" style="background-color: var(--main-bg);">
                        <img src="assets/icons/shield_person_24.svg" alt="Star Icon" width="36" height="36">
                    </div>
                    <h4>Safety First</h4>
            ...
            <div class="col-md-4">
                <div class="mission-card p-4 h-100 bg-white rounded shadow-sm text-center">
                    <div class="icon-box bg-opacity-10 text-primary rounded-circle p-3 mb-3 d-inline-flex mx-auto" style="background-color: var(--main-bg);">
                        <img src="assets/icons/heart_check_24.svg" alt="Star Icon" width="36" height="36">
                    </div>
...
<!-- Stats Section -->
<section class="py-5  text-white" style="background-color: var(--main-bg);">
    <div class="container">
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="team-member text-center p-4 bg-white rounded shadow-sm">
                    ...
                    <p class="text-info fw-bold">Chief Warden</p>
            ...
            <div class="col-md-4">
                <div class="team-member text-center p-4 bg-white rounded shadow-sm">
                    ...
                    <p class="text-info fw-bold">Deputy Warden</p>
            ...
            <div class="col-md-4">
                <div class="team-member text-center p-4 bg-white rounded shadow-sm">
                    ...
                    <p class="text-info fw-bold">Systems Manager</p>
...
<section class="py-5   text-white" style="background-color: var(--main-bg);">
    <div class="container text-center">
        ...
        <a href="<?= BASE_URL ?>/student/register.php"
            ...
            onmouseover="this.style.backgroundColor='#395a7aff'; this.style.color='white';"
