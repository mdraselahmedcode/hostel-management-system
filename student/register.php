...
<div class="content container mt-4">
    ...
    <form id="register-student-form" enctype="multipart/form-data">
        ...
        <div class="d-grid gap-2 mt-4">
            ...
            <a href="<?= BASE_URL . '/student/login.php' ?>" class="btn btn-outline-secondary">
...
<script>
    ...
    $(document).ready(function() {
        $('#register-student-form').on('submit', function(e) {
            ...
            showSlideMessage('<div class="spinner-border spinner-border-sm" role="status"></div> Processing...', 'info');
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        }, 1500); // Optional delay to let the message show briefly
                    } else {
...
<?php require_once BASE_PATH . '/includes/footer_student_login.php'; ?>